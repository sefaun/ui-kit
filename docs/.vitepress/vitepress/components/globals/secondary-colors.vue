...
const colorsType = ['success', 'warning', 'danger', 'info', 'fade']
    ...
    <el-col v-for="(type, i) in colorsType" :key="i" :span="6" :xs="{ span: 12 }">
      <div class="demo-color-box" :style="{ background: getColorValue(type) }">
        ...
        <div class="bg-color-sub">
          <div v-for="(level, key) in colorLevel" :key="key" class="bg-secondary-sub-item transition cursor-pointer hover:shadow" :style="{
            width: `${100 / 6}%`,
